---
title: Hub – Vault SécuritéPublique_AI
date: 2026-01-05
type: hub
publicable: true
...
- [x] Fichiers de base créés avec placeholders
- [ ] Recherche documentaire (lois, règlements)
- [ ] Collecte des faits
- [ ] Analyse juridique
- [ ] Synthèse

## Prochaines étapes
1. Compléter les bases légales (lois et règlements)
2. Collecter les documents administratifs (autorisations, rapports de contrôle)
3. Documenter les faits établis
4. Analyser la jurisprudence pertinente
5. Identifier les questions juridiques clés

## Contact et sources
### Sources communales
- Organigramme administratif 2021 (PDF, p.2)
- Répartition des dicastères 2025–2028 (page officielle)
- Mention “organigramme exécutif validé” (actualités communales)
- RIOC modifié au 01.04.2025 (PDF)

### Bases légales VS
- https://lex.vs.ch/data/540.1/fr (LPIEN, RS 540.1)
- https://lex.vs.ch/data/540.100/fr (Ordonnance d’exécution protection incendie/éléments naturels, RS 540.100)
- https://lex.vs.ch/data/935.3/fr (LHR, RS 935.3)
- https://lex.vs.ch/data/935.300/fr (OHR, RS 935.300)

### Normes AEAI
- TODO: URL officielle “Prescriptions de protection incendie 2015” (PDF)
...
- https://www.commune-cransmontana.ch/media/document/0/reglement-interne-d-organisation-communale-rioc_2.pdf
