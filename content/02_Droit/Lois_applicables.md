---
title: Lois applicables – Valais (état 2025)
date: 2026-01-05
type: droit
publicable: true
...
%%{init: {'theme':'base', 'themeVariables': { 'primaryColor':'#2C3E50', 'primaryTextColor':'#fff', 'primaryBorderColor':'#7F8C8D', 'lineColor':'#3498DB', 'secondaryColor':'#7F8C8D', 'tertiaryColor':'#f4f4f4'}}}%%
  ...
  classDef tech fill:#e0e7ff,color:#3730a3,stroke:#6366f1

  CST["Constitution fédérale (Cst.)"]:::fed
  LOIS_FED["Lois fédérales (CPP, CO, etc.)"]:::fed
  CST_VS["Constitution VS"]:::cant
  LOIS_VS["Lois cantonales (LPIEN, LHR)"]:::cant
  ORD_VS["Ordonnances VS (OHR, etc.)"]:::cant
  REGL_COMM["Règlements communaux"]:::comm
  NORMES_TECH["Normes techniques (AEAI, SIA)"]:::tech
  ...
  LOIS_VS --> ORD_VS
  ORD_VS --> REGL_COMM
  LOIS_VS -.->|"intégration"| NORMES_TECH
```
